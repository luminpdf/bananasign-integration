...
var CustomInput = React.forwardRef(function (props, ref) {
  var classWrapper = props.classWrapper,
    ...
    hideValidationIcon = props.hideValidationIcon,
    ...
    isErrorBorder = props.isErrorBorder,
    showErrorMessageOnFocus = props.showErrorMessageOnFocus,
  ...
  var shouldShowErrorIcon =
    error && !isFocus && !hideValidationIcon && isActive;
  var shouldShowClearButton =
    showClearButton &&
    isActive &&
    Boolean(value === null || value === void 0 ? void 0 : value.length);
  ...
  return _jsxs(
    ...
    __assign(
      {
        className: classNames('CustomInput-container '.concat(classWrapper), {
          fullWidth: fullWidth,
        }),
      },
      {
        children: [
          label &&
            _jsx(
              ...
              __assign(
                {
                  className: 'CustomInput__label '.concat(labelClassName),
                  htmlFor: 'input',
                },
                {children: label},
              ),
                    ...
                    __assign(
                      {
                        ...
                        className: classNames(
                          'CustomInput__input '.concat(className),
                          {
          ...
          shouldShowErrorMessage &&
            ...
            _jsx(
              'p',
              __assign(
                {className: 'CustomInput__error-message'},
