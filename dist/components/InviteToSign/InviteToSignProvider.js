...
var InviteToSignProvider = function (_a) {
    var children = _a.children, onClose = _a.onClose, signers = _a.signers, viewers = _a.viewers, saveDocumentInfo = _a.saveDocumentInfo, bananasignUrl = _a.bananasignUrl;
    ...
    var _b = useReducer(InviteToSignContextReducer, __assign(__assign({}, initialState), { signers: signersData, viewers: viewersData, onClose: onClose, saveDocumentInfo: saveDocumentInfo, bananasignUrl: bananasignUrl || BANANA_SIGN_WEB_URL })), state = _b[0], dispatch = _b[1];
    return (_jsx(InviteToSignContext.Provider, __assign({ value: { state: state, dispatch: dispatch } }, { children: children })));
};
var defaultProps = {
    children: null,
};
