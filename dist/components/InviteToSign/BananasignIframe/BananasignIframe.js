...
var BananasignIframe = function () {
    ...
    var _a = context.state, openBananasignIframe = _a.openBananasignIframe, onClose = _a.onClose, identify = _a.identify, bananasignUrl = _a.bananasignUrl, dispatch = context.dispatch;
    ...
    return (_jsx("div", __assign({ className: "BananasignIframe__container" }, { children: _jsx("iframe", { width: "100%", height: "100%", src: "".concat(bananasignUrl, "/embed/").concat(identify), title: "Iframe Upload", frameBorder: "0", allow: "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture", id: "bananaSignIframe", onLoad: function () {
            ...
            }, style: { visibility: 'hidden' }, allowFullScreen: true }) })));
};
