...
var InputAssigner = React.forwardRef(function (props, ref) {
    ...
    var onFocus = props.onFocus, onBlur = props.onBlur, isOpenSearch = props.isOpenSearch;
    ...
    useImperativeHandle(ref, function () { return ({
        unFocusInput: function () { var _a; return (_a = customInputRef === null || customInputRef === void 0 ? void 0 : customInputRef.current) === null || _a === void 0 ? void 0 : _a.unFocus(); },
        resetInput: function () {
            var _a;
            (_a = customInputRef === null || customInputRef === void 0 ? void 0 : customInputRef.current) === null || _a === void 0 ? void 0 : _a.reset();
            setEmail('');
    ...
    var isEmptyAssignUsers = Array.isArray(assignUsersAdded) && assignUsersAdded.length === 0;
    ...
    return (_jsxs("div", __assign({ className: classNames('InputAssigner__container', {
            isOpenSearch: isOpenSearch,
            EmptyAssignUsers: isEmptyAssignUsers,
        }) }, { children: [!isEmptyAssignUsers && (_jsxs(_Fragment, { children: [_jsx(AssignerListInput, {}), _jsx("div", { className: "InputAssigner__divider" })] })), _jsx(CustomInput, { ref: customInputRef, name: "name", fullWidth: true, value: email, icon: Images.icon_search, type: "email", onChange: handleChangeInput, placeholder: "Enter email address", minLength: 1, maxLength: 254, onFocus: onFocus, onBlur: onBlur, classWrapper: "InputAssigner__wrapper--input", className: "InputAssigner__input", showClearButton: true })] })));
});
