...
var SearchContactEmptyKeyWords = function () {
  return _jsxs(
    'div',
    __assign(
      {className: 'NoKeyWords__container'},
      {
        children: [
          _jsx(
            'div',
            __assign(
              {className: 'NoKeyWords__banner'},
              {
                children: _jsx('img', {
                  src: Images.image_no_key_words,
                  alt: 'NoKeyWords__banner',
                }),
              },
            ),
          ),
          _jsx(
            'h4',
            __assign(
              {className: 'NoKeyWords__title'},
              {children: 'Search all contacts'},
            ),
          ),
          _jsx(
            'p',
            __assign(
              {className: 'NoKeyWords__message'},
