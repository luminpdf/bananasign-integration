...
ReactDom.render(_jsx(_Fragment, { children: _jsx(Suspense, __assign({ fallback: _jsx("div", { children: "Loading..." }) }, { children: _jsx(BananasignWidget, { isOpen: true, onClose: function () { return console.log('onClose'); }, signers: signers, viewers: viewers, saveDocumentInfo: function (_a) {
                var viewers = _a.viewers, signers = _a.signers;
