...
var a = require('react/jsx-runtime'),
  ...
  r = require('react'),
  e = require('react-modal'),
  t = require('react-spring'),
  i = require('react-tooltip'),
  l = require('react-lottie-player');
function s(n) {
        ...
        for (; i; )
          try {
            if (
              ...
              return e;
            switch (((r = 0), e && (t = [2 & t[0], e.value]), t[0])) {
              case 0:
              case 1:
                e = t;
                break;
              ...
              default:
                ...
                if (3 === t[0] && (!e || (t[1] > e[0] && t[1] < e[3]))) {
                  i.label = t[1];
                  break;
                }
                if (6 === t[0] && i.label < e[1]) {
                  (i.label = e[1]), (e = t);
                  break;
                }
                if (e && i.label < e[2]) {
                  (i.label = e[2]), i.ops.push(t);
                  break;
                }
...
function y(n, a, o) {
  if (o || 2 === arguments.length)
    for (var r, e = 0, t = a.length; e < t; e++)
      (!r && e in a) ||
        (r || (r = Array.prototype.slice.call(a, 0, e)), (r[e] = a[e]));
  return n.concat(r || Array.prototype.slice.call(a));
}
n(
    ...
    u(
      {
        ...
        className: 'ReactModal__Content--custom '.concat(l),
      },
      {
        children: [
          s &&
            a.jsx(
              'div',
              u(
                {className: 'ReactModal__ButtonClose', onClick: e},
                {children: a.jsx('img', {src: h, alt: 'icon close'})},
              ),
            ),
          o,
        ],
...
var k = function (n) {
    var o = n.className,
      ...
      g = (function (n) {
        if (n) {
          var a = f.default.useState({x: -1, y: -1}),
            o = a[0],
            r = a[1],
            e = f.default.useState(!1),
            t = e[0],
            i = e[1];
          return (
            f.default.useEffect(
            ...
            {setCoords: r, coords: o, isRippling: t}
          );
        }
      })(d || !0);
    return a.jsxs(
      ...
      u(
        {
          className: c.default(''.concat(o, ' Button__Container ').concat(p), {
            'button-disabled': i,
          }),
          onClick: function (n) {
            if (d) {
              ...
              null == g ||
                g.setCoords({x: n.clientX - a.left, y: n.clientY - a.top});
            }
            l && l();
          },
          style: s,
        ...
        },
        {
          children: [
            d &&
              (null == g ? void 0 : g.isRippling) &&
              a.jsx('span', {
                className: 'Button__ripple',
                style: {
                  left: null == g ? void 0 : g.coords.x,
                  top: null == g ? void 0 : g.coords.y,
                },
              }),
            t &&
              a.jsx(
...
var R = {
  ...
  J = 'CLOSE_AND_RESET_MODAL_SEARCH',
  Q = 'OPEN_BANANASIGN_IFRAME',
  X = 'SET_MODAL_WARNING_TYPE',
  $ = 'SET_DOCUMENT_SIGNING',
  K = function (n) {
...
var mn = f.default.forwardRef(function (n, o) {
  var e = n.classWrapper,
    t = n.className,
    i = n.onFocus,
    l = n.onBlur,
    s = n.label,
    ...
    B = r.useRef(null),
    j = F && !E && !b && N,
    P = m && N && Boolean(null == h ? void 0 : h.length),
    R = E || (!F && Boolean(h && !k)),
    L = !R || D;
  return (
    ...
    a.jsxs(
      ...
      u(
        {
          className: c.default('CustomInput-container '.concat(e), {
            fullWidth: g,
          }),
        },
        {
          children: [
                      ...
                      u(
                        {
                          ...
                          className: c.default(
                            'CustomInput__input '.concat(t),
                            {
                              ...
                              'CustomInput__input--hasIcon': j || P,
            ...
            L &&
              ...
              a.jsx(
                'p',
                u({className: 'CustomInput__error-message'}, {children: d}),
              ),
          ],
        },
      ),
...
var Cn = function () {
    ...
    var b = function (n) {
      ...
      m = g(function (n, o, r, e) {
        var i = null == o ? void 0 : o.isOwner;
        return a.jsxs(
          t.animated.div,
          u(
              ...
              children: [
                ...
                a.jsx(
                  ...
                  u(
                    ...
                    {children: a.jsx('img', {src: x, alt: 'icon remove'})},
                  ),
                ),
              ],
            },
    ...
    return a.jsxs(
      ...
      u(
        ...
        {children: [m, a.jsx('div', {ref: n})]},
      ),
    );
  },
  _n = f.default.forwardRef(function (n, o) {
    ...
    r.useImperativeHandle(o, function () {
      return {
        unFocusInput: function () {
          var n;
          return null === (n = null == x ? void 0 : x.current) || void 0 === n
            ? void 0
            : n.unFocus();
        },
        resetInput: function () {
...
var Dn = function (n) {
  var o = n.className,
        ...
        return i || l
          ...
          : a.jsx(
              ...
              u(
                ...
                {children: hn((null == e ? void 0 : e.name) || '')},
              ),
            );
      },
    ...
    f = r.useMemo(
      function () {
        return a.jsx('img', {
          src: e.avatarRemoteId,
          alt: 'user avatar',
          onError: function (n) {
            var a = n.currentTarget;
            (a.onerror = null), (a.src = w), (a.style.padding = '4px');
          },
        });
      },
      [null == e ? void 0 : e.avatarRemoteId],
    );
  return a.jsx(
    'div',
    u(
      {className: 'Avatar__wrapper'},
      {
        children: a.jsx(
          'div',
          u(
            {style: t, className: c.default('Avatar__container '.concat(o))},
            {
              children:
                ((null == e ? void 0 : e.avatarRemoteId) && f) ||
                ((null == e ? void 0 : e.name) && s) ||
                null,
            },
          ),
        ),
...
var Mn = r.memo(Dn),
  In = function (n) {
    var o = n.user,
      ...
      l = n.role,
      s = n.disabled,
      f = 'Guest User' === (null == o ? void 0 : o.name),
      ...
      u(
        {
          ...
          className: c.default('AssignerItem__container '.concat(r), {
            disabled: s,
          }),
        },
        {
            ...
            e &&
              a.jsxs(
                ...
                u(
                  {
                    onClick: function () {
                      p.default.hide(), i && 'function' == typeof i && i(o);
                    },
                    'data-tip': g,
...
var En = r.memo(In),
  An = f.default.forwardRef(function (n, o) {
    var e = n.active,
      t = n.resetInput,
      i = r.useContext(L),
      l = i.state,
      ...
      b = r.useCallback(
        function (n) {
          return (
            y(y([], f, !0), d, !0).findIndex(function (a) {
    ...
    return a.jsx(
      'div',
      u(
        {className: c.default('SearchContact__container', {active: e}), ref: o},
        {
          children:
            s.length > 0
              ? a.jsx(
...
var Fn,
  Nn = r.memo(An),
  Bn = (((Fn = {})[M] = 'Add Signer'), (Fn[I] = 'Add Viewer'), Fn),
  jn = function () {
    var n,
      o,
      e = r.useContext(L),
      t = e.state,
      i = t.isOpenAddAssignerModal,
      l = t.type,
      s = t.signers,
      c = t.viewers,
      f = e.dispatch,
    ...
    var y = function () {
      ...
      h = r.useMemo(
        function () {
          var n;
          return (((n = {})[M] = s), (n[I] = c), n)[l].some(function (n) {
...
var Vn = [
                        ...
                        children: Vn.map(function (n) {
                          return a.jsx(
                            ...
                            u(
                              ...
                              {children: a.jsx('span', {children: n.value})},
                            ),
                            n.value,
                          );
                        }),
  ...
  Un = function (n, a) {
    switch (a.type) {
      case S:
        return u(u({}, n), {loading: a.payload});
      case O:
        return u(u({}, n), {isOpenAddAssignerModal: a.payload});
      case H:
        var o = y([], n.signers, !0).filter(function (n) {
          return n.email !== a.payload.email;
        });
        return u(u({}, n), {signers: o});
      case U:
        var r = y([], n.viewers, !0).filter(function (n) {
          return n.email !== a.payload.email;
        });
        return u(u({}, n), {viewers: r});
      case G:
        return u(u({}, n), {keyWordSearchContact: a.payload});
      case W:
        return u(u({}, n), {searchContacts: a.payload});
      case Z:
        return n.viewers.findIndex(function (n) {
          return n.email === a.payload.email;
        }) > -1
          ? u({}, n)
          : u(u({}, n), {viewers: y(y([], n.viewers, !0), [a.payload], !1)});
      case z:
        return n.signers.findIndex(function (n) {
          return n.email === a.payload.email;
        }) > -1
          ? u({}, n)
          : u(u({}, n), {signers: y(y([], n.signers, !0), [a.payload], !1)});
      case Y:
        return u(u({}, n), {type: a.payload});
      case q:
        return u(u({}, n), {cancelAddAssigners: a.payload});
      case V:
        return u(u({}, n), {signers: a.payload});
      case T:
        return u(u({}, n), {viewers: a.payload});
      case J:
        return u(u({}, n), {
          searchContacts: [],
          keyWordSearchContact: '',
      ...
      case Q:
        return u(u({}, n), {openBananasignIframe: a.payload});
      case X:
        return u(u({}, n), {modalWarningData: a.payload});
      case $:
        return u(u({}, n), a.payload);
      default:
        return;
    }
  },
...
var zn = function () {
    var n = r.useContext(L),
      ...
      e = o.signers,
      t = o.viewers,
      i = o.isOpenAddAssignerModal,
      l = o.cancelAddAssigners,
      s = o.loading,
      f = o.flowId,
      d = o.bananasignBaseUrl,
      p = n.dispatch,
      g = r.useState([]),
      h = g[0],
      x = g[1],
    ...
    r.useEffect(
      function () {
        i || (l ? (p(fn(h)), p(dn(v)), p(cn(!1))) : (x(e), C(t)));
      },
      [i, e, t],
    );
    var _ = function (n) {
      ...
      k = function (n) {
        p(an(n)), (null == n ? void 0 : n.isOwner) && p(dn(y([n], t, !0)));
      },
      E = function (n) {
        p(on(n)), (null == n ? void 0 : n.isOwner) && p(fn(y([n], e, !0)));
      };
    return a.jsxs(
      'div',
      u(
        {className: 'InviteUser__container'},
        {
          children: [
            a.jsx(
              'h1',
              u({className: 'InviteUser__title'}, {children: 'Invite people'}),
            ),
            a.jsxs(
              'div',
              u(
                          ...
                          return m(this, function (a) {
                            ...
                            try {
                              (n = {
                                ...
                                fetch(''.concat(d, '/v1/document-signing'), n)
                                  .then(function (n) {
                                    return n.json();
                                  })
                                  .then(function (n) {
...
var Wn,
  Yn = function () {
    return r.useContext(L).state.loading
      ? a.jsx(
          'div',
          u(
            {className: 'Loading__container'},
            {
              children: a.jsx(g.default, {
                loop: !0,
                animationData: v,
                play: !0,
...
var Jn =
  ...
  Qn = function () {
    var n = r.useContext(L),
      o = n.state.modalWarningData,
      e = n.dispatch,
      t = function () {
        e(un({type: ''})),
          o.onCancel && 'function' == typeof o.onCancel && o.onCancel();
      };
    ...
    return a.jsx(
      _,
      u(
        {isShowCloseButton: !1, isOpen: !0, closeModal: t},
        {
          children: a.jsxs(
            'div',
            u(
    ...
    u(
      ...
      },
      {
        children: a.jsxs(
          'div',
          u(
            {className: c.default('InviteToSign__container', {open: o})},
            {
              children: [
                a.jsx(Hn, {}),
                a.jsx(Gn, {}),
