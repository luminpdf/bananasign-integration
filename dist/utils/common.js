...
var serializeAssigners = function (assigners, requestType) {
    var serializeSigners = assigners.map(function (assigner, index) {
        return __assign(__assign({}, assigner), { name: (assigner === null || assigner === void 0 ? void 0 : assigner.name) || GUEST_USER, isOwner: requestType === REQUEST_TYPE.SIGNER && index === 0, id: (assigner === null || assigner === void 0 ? void 0 : assigner.id) || '', requestType: requestType, dueTimeExpired: 0 });
    });
